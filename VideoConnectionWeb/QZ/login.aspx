            ...
            <div class="container-login100">
                <div class="wrap-login100">
                    ...
                    <div action="#" class="login100-form validate-form">
                        ...
                        <div class="wrap-input100 validate-input m-b-18" style="position: relative;"
                            data-validate="验证码不能为空">
                            <span class="label-input100">验证码</span>
                            <input class="input100" type="number" id="YZM" maxlength="4" name="code"
                                placeholder="请输入验证码" style="width:50%;display:inline-block;">
                            <span class="focus-input100"></span>
                            <div onclick="change()"
                                style="position:absolute;right:0;top:0;display: flex;justify-content:center;align-items:center;">
                                <img id="myCheckCode" src="/image.aspx" />
                                <div style="color:blue;text-decoration: underline;">换一张</div>
                            </div>
                        </div>
