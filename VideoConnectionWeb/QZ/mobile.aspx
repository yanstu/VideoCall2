<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mobile.aspx.cs" Inherits="VideoConnectionWeb.mobile" %>
  <!DOCTYPE html>
  <html lang="en">
  ...
  <body class="w-screen h-screen">
    <header style="box-shadow: 0 1px 3px 0 rgba(0, 0, 0, 0.07), 0 1px 2px 0 rgba(0, 0, 0, 0.05) !important;"
      class="flex flex-row whitespace-nowrap h-[7%] bg-[#262626] w-full justify-between">
      <div style="width: 15%;" class="flex items-center justify-start">
        ...
        <img id="qiehuanshitu_btn" title="切换视图" class="invert-[100%]" src="./img/shitu.png"
          style="width: auto;height: 55%;" />
      </div>
      <div style="text-align: center;"
        class="text-white w-[50%] pl-3 h-full flex items-center justify-center text-center text-[16px]">
        <div id="roomTitle" class="overflow-hidden text-ellipsis whitespace-nowrap w-full">
        </div>
      </div>
    ...
    <section class="h-[93%] flex flex-row w-full bg-[#24292e]">
      ...
      <div id="buxianshi" style="width: 0px;height: 0px;">
        <div id="buxianshi1" style="width: 0px;height: 0px;">
        </div>
      </div>
    </section>
    ...
    <script src="./js/mobile/common.js?t=202203260344"></script>
    <script src="./js/rtc-detection.js"></script>
    <script src="./js/mobile/rtc-client.js?t=202203260344"></script>
    ...
    <script defer src="./js/mobile/chatHub.js?t=202203260344"></script>
